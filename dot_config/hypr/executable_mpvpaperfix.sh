#!/bin/bash
# Fix mpvpaper memory leak by restarting every 30min
...
start_mpvpaper() {
  ...
  mpvpaper -s -o "no-audio loop hwdec=auto gpu-api=vulkan" ALL ~/Videos/wallpaper/garden-house-lofi-rainy-day-moewalls-com-ctp-macchiato.mp4 &
